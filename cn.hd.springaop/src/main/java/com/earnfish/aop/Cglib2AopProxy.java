...
public class Cglib2AopProxy extends AbstractAopProxy{
	...
	public Object getProxy() throws Exception {
		...
		enhancer.setSuperclass(advised.getTargetSource().getTargetClass());//设置需要增强处理的目标类
		enhancer.setInterfaces(advised.getTargetSource().getInterfaces());//设置需要增强处理类的方法
	...
	private static class DynamicAdvisedInterceptor implements MethodInterceptor {
		...
		public Object intercept(Object object, Method method, Object[] arg,
			...
			if(advised.getMethodMatcher() == null
				...
				return delegateMethodInterceptor.invoke(new CglibMethodInvocation(advised.getTargetSource().getTarget(), method, arg, proxy));
			}
			//有AspectJ表达式，但没有匹配该方法，返回通过methodProxy调用原始对象的该方法
			return new CglibMethodInvocation(advised.getTargetSource().getTarget(), method, arg, proxy).proceed();
		} 
	}
